...
class AnuciousuarioController extends Controller
{
        public function anunciospersonales()//Esta función obtiene los anuncios publicados del usuario que se enuentra logeado en la página.
    {
            ...
            ->select('a.idanuncio','a.titulo','r.nombre_region as region','a.estado','c.nombre as categoria','u.name as usuario','a.descripcion','a.imagen','a.id_secretaria','a.precio','ta.nombre_tipo as tipo_anuncio','a.comentario_secretaria')
