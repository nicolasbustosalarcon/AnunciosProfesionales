...
use AnunciosProfesionales\Mostrar;
use DB;
use DateTime;
use Auth;
...
class MostrarAnuncioController extends Controller
{
...
*/
    ...
    */
    ...
    public function edit($id)
    {
    	...
    	$categorias=DB::table('categoria')->where('condicion','=','1')->get();
        return view("almacen.secretaria_anuncio.edit",["anuncio"=>$anuncio,"categorias"=>$categorias]);
    }
