          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{url('almacen/anuncio')}}"><i class="fa fa-circle-o"></i>Busca Anuncios</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{url('almacen/editar_usuario')}}"><i class="fa fa-circle-o"></i>Editar perfil</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{url('almacen/vermensajes')}}"><i class="fa fa-circle-o"></i>Ver todos los mensajes</a></li>
